package jenkis_Read_FromExcelSheet;
...
public class ExcelCode {
	...
	public  Object[][] getTutorialsTNEscelLoginData() throws Exception {
		    Object [][] data = ExcelCode.readFromExeclSheetTNLogin("Login");
		    return data;
	}
	public static Object[][] readFromExeclSheetTNLogin(String sheetName) throws Exception {
		//5. Create the Object of FileInputStream class and pass the path of the Excel sheet in its Constructor
		 ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\jenkis_Read_FromExcelSheet\\Book1.xlsx");
	...
	public  Object[][] getTutorialsTNEscelRegisterData() throws Exception {
		    Object [][] data = ExcelCode.readFromExeclSheetTNRegister("Register");
		    return data;
	}
	public static Object[][] readFromExeclSheetTNRegister(String sheetName) throws Exception {
		//5. Create the Object of FileInputStream class and pass the path of the Excel sheet in its Constructor
		 ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\Day17_Read_FromExcelSheet\\Book1.xlsx");
	//6. Create the Object of XSSFWorkbook class
		 workbook = new XSSFWorkbook(ip);
	//7. use the workbook reference to address individual sheet
		sheet = workbook.getSheet(sheetName);
